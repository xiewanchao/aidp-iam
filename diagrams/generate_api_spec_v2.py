...
PERM_GROUPS = [
    ...
    ("knowledgebase", "kb_browse", "option1 读：知识库/目录映射/文件/文件系统（GET + POST 分页查询）",
        [("/kb/knowledge_bases", "GET"),
         ("/kb/knowledge_bases/files", "POST"),
         ("/kb/knowledge_bases/files/history", "POST")], ["all-users"]),
    ...
    ("knowledgebase", "kb_jargon_bind", "option7: 知识库-术语库关联（绑定/解绑）",
        [("/kb/jargon_groups/knowledge_bases/add", "POST"),
         ("/kb/jargon_groups/knowledge_bases/remove", "POST")], ["kb-admins"]),
...
ENDPOINTS = [
    # ========= KB (apioption.md 7 大类 × 读/编辑) =========
    # option 1: 知识库管理（all-users；编辑走 resource_acl）
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/page",              YES, YES, NO, NO, RES, "X-Allowed-Ids 过滤"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/count",             YES, YES, NO, NO, RES, ""),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases",                   YES, YES, NO, NO, RES, "?kbs_id=... viewer"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/mappings",          YES, YES, NO, NO, RES, "viewer on kb"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/mappings/count",    YES, YES, NO, NO, RES, ""),
    ("KB", "kb_browse",       "POST", "/kb/knowledge_bases/files",             YES, YES, NO, NO, RES, "分页查询 (body.kbs_id)"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/files/count",       YES, YES, NO, NO, RES, ""),
    ("KB", "kb_browse",       "POST", "/kb/knowledge_bases/files/history",     YES, YES, NO, NO, RES, "入库历史"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/files/filesystem",  YES, YES, NO, NO, RES, "暂未支持"),
    ("KB", "kb_browse",       "GET",  "/kb/knowledge_bases/jargon_groups",     YES, YES, NO, NO, RES, "指定 KB 绑定的术语库"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/add",               YES, YES, NO, NO, YES, "创建者成 owner"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/modify",            YES, YES, NO, NO, RES, "contributor"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/remove",            YES, YES, NO, NO, RES, "owner, ACL 级联删"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/mappings/add",      YES, YES, NO, NO, RES, "contributor"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/mappings/remove",   YES, YES, NO, NO, RES, "contributor"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/files/upload",      YES, YES, NO, NO, RES, "contributor"),
    ("KB", "kb_edit",         "POST", "/kb/knowledge_bases/files/remove",      YES, YES, NO, NO, RES, "contributor"),
    # option 2: 模型配置（kb-admins 独占）
    ("KB", "kb_model_view",   "GET",  "/kb/models/config",                     YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_model_edit",   "POST", "/kb/models/config/add",                 YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_model_edit",   "POST", "/kb/models/config/modify",              YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_model_edit",   "POST", "/kb/models/config/remove",              YES, YES, NO, NO, NO,  ""),
    # option 3: 提示词管理（读 all-users；编辑 kb-admins）
    ("KB", "kb_prompt_view",  "GET",  "/kb/prompts/detail",                    YES, YES, NO, NO, YES, ""),
    ("KB", "kb_prompt_view",  "GET",  "/kb/prompts/options",                   YES, YES, NO, NO, YES, ""),
    ("KB", "kb_prompt_view",  "GET",  "/kb/prompts/page",                      YES, YES, NO, NO, YES, ""),
    ("KB", "kb_prompt_edit",  "POST", "/kb/prompts/add",                       YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_prompt_edit",  "POST", "/kb/prompts/modify",                    YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_prompt_edit",  "POST", "/kb/prompts/remove",                    YES, YES, NO, NO, NO,  ""),
    # option 4: 术语管理（全部 kb-admins）
    ("KB", "kb_jargon_view",  "GET",  "/kb/jargon_groups",                     YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_view",  "GET",  "/kb/jargon_groups/jargons",             YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_view",  "GET",  "/kb/jargon_groups/version",             YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_view",  "GET",  "/kb/jargons_groups/jargon",             YES, YES, NO, NO, NO,  "api.md 拼写即如此"),
    ("KB", "kb_jargon_edit",  "POST", "/kb/jargon_groups/add",                 YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_edit",  "POST", "/kb/jargon_groups/remove",              YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_edit",  "POST", "/kb/jargons/add",                       YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_edit",  "POST", "/kb/jargons/modify",                    YES, YES, NO, NO, NO,  ""),
    ("KB", "kb_jargon_edit",  "POST", "/kb/jargons/remove",                    YES, YES, NO, NO, NO,  ""),
    # option 5: 问答（all-users）
    ("KB", "kb_conv_view",    "GET",  "/kb/conversations/list",                YES, YES, NO, NO, RES, "暂未支持"),
    ("KB", "kb_conv_view",    "GET",  "/kb/conversations",                     YES, YES, NO, NO, RES, "单对话，暂未支持"),
    ("KB", "kb_conv_view",    "GET",  "/kb/conversations/images/download",     YES, YES, NO, NO, RES, "viewer 继承父 KB"),
    ("KB", "kb_conv_edit",    "POST", "/kb/conversations/start",               YES, YES, NO, NO, YES, "创建 conversation"),
    ("KB", "kb_conv_edit",    "POST", "/kb/conversations/stop",                YES, YES, NO, NO, RES, "owner"),
    ("KB", "kb_conv_edit",    "POST", "/kb/conversations/remove",              YES, YES, NO, NO, RES, "owner, 暂未支持"),
    ("KB", "kb_conv_edit",    "POST", "/kb/conversations/images/generate",     YES, YES, NO, NO, RES, "viewer"),
    # option 6: 检索（all-users）
    ("KB", "kb_retrieval",    "POST", "/kb/retrieval/fusion_search",           YES, YES, NO, NO, RES, "viewer on kds_list"),
    # option 7: 知识库-术语库关联（kb-admins）
    ("KB", "kb_jargon_bind",  "POST", "/kb/jargon_groups/knowledge_bases/add",    YES, YES, NO, NO, NO, ""),
    ("KB", "kb_jargon_bind",  "POST", "/kb/jargon_groups/knowledge_bases/remove", YES, YES, NO, NO, NO, ""),
