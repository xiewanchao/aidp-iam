...
```text
artifacts/images/gateway/{arm64|amd64}/
```
...
The default image names and tags intentionally match `deploy/helm/aidp-gateway/values.yaml`, so the chart can be installed without image override values after loading these tar files.
